            ...
            <section>
                ...
                <div class="card1">
                    ...
                    <div class="card-body">
                      ...
                      <div class="clearfix">
                        <img src="../img/b4.jpg" class="col-md-6 float-md-end mb-3 ms-md-3" alt="...">
                        <p>Chapeu</p>
                        <b>Quantidade / Preço: </b>
                        <select id="quantidade" name="quantidade" required>
                          <option value="1" selected>1 / 5.00kz</option>
                          <option value="2">2 / 1.000kz</option>
                          <option value="2">3 / 1.500kz</option>
                          <option value="2">4 / 2.000kz</option>
                        </select>
                        <br><br>
