            ...
            <section>
                ...
                <div class="card1">
                    ...
                    <div class="card-body">
                      ...
                      <div class="clearfix">
                        <img src="../img/m.jpg" class="col-md-6 float-md-end mb-3 ms-md-3" alt="...">
                        <p>Saco de Tomate</p>
                        <b>Quantidade / Preço: </b>
                        <select id="quantidade" name="quantidade" required>
                          <option value="1" selected>1 / 1.200kz</option>
                          <option value="2">2 / 2.400kz</option>
                          <option value="2">3 / 3.600kz</option>
                          <option value="2">4 / 4.800kz</option>
                        </select>
                        <br><br>
